...
<div style="margin:22px;">
	<h3><i>To add a new member in the team you are currently looking in, just provide the new member's name and his/her's designation in the team/company. </i> </h3>

</div>
<div style="background-color: #1f1f14; height: 500px; margin-top: -100px;">

<div style="margin:110px; padding: 50px;">
<form action="MemAdd" method="post">
	<input type="hidden" name="team" value='<%=request.getAttribute("team") %>'>
	<h4><font style="color: white;">Member Name :</font></h4><input class="form-control" id="focusedInput" type="text" name="mem" style=" width: 400px;" required>
